 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <div class="bat-on">
        <a href="home-contant1.php" type="button" class="btn btn-success">Showing Data</a>
      <a href="home-page-contant1-datainsart.php" type="button" class="btn btn-info">Data Inseart</a>
      <a href="home-page-contant1-dataupdate.php" type="button" class="btn btn-warning">Data Update</a>
      <a href="home-page-contant1-dataDelete.php" type="button" class="btn btn-danger">Data Delete</a>

      <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-11">
      <div class="data-update">
        <form action="home-page-contant1-dataupdate.php" method="post">
          <?php

          $count=1;

          //$qur = 'Select * from p-saba ORDER BY id desc;';
          $qur = "SELECT `id`, `title`, `img`, `contant1`, `contant2`, `contant3`, `contant4` FROM `p-saba`";
          ...
          <table style="width: 70%;">
            ...
            <tr><td style=" font-size: 15px; text-align: center; width: 30%; padding: 20px;"><a href="home-page-contant1-dataedit.php?id=<?php echo $data["id"]; ?>" type="button" class="btn btn-warning">Data Edit</a></td></tr>
            <?php $count++;}?>
          </table>
        </form>
      </div>
