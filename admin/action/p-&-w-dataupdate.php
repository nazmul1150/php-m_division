...
if (isset($_POST['submit'])) { 
  ...
  $qur = "UPDATE `p-&-w` SET `title`='$h1',`img`='$file_name',`contant1`='$cn1',`contant2`='$cn2',`contant3`='$cn3',`contant4`='$cn4' WHERE `id`='$sid'";
  ...
  if ($run===TRUE) {
    ...
    window.open('../home-page-contant4-dataupdate.php','_self');
  </script>
