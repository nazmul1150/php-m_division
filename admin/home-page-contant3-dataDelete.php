...
<div class="row">
      ...
      <div class="data-update">
        <form action="home-page-contant3-dataDelete.php" method="post">
          <?php
          ...
          <table style="width: 70%;">
            ...
            <tr><td style=" font-size: 15px; text-align: center; width: 30%; padding: 20px;"><a href="action/n-&-s-datadelet.php?id=<?php echo $data["id"]; ?>" type="button" class="btn btn-warning">Data Delete</a></td></tr>
            <?php $count++;}?>
          </table>
        </form>
      </div>
