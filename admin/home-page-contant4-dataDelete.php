...
<div class="row">
      ...
      <div class="data-update">
        <form method="post" action="home-page-contant4-dataDelete.php">
          <?php
          ...
          <table style="width: 70%;">
            ...
            <tr><td style=" font-size: 15px; text-align: center; width: 30%; padding: 20px;"><a href="action/p-&-w-datadelet.php?id=<?php echo $data["id"]; ?>" type="button" class="btn btn-warning">Data Delete</a></td></tr>
            <?php $count++;}?>
          </table>
        </form>
      </div>
