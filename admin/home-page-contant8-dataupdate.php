  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <div class="data-update">
        <form action="home-page-contant8-dataupdate.php" method="post">
          <?php

          $count=1;

          //$qur = 'Select * from p-saba ORDER BY id desc;';
          $qur = "SELECT `id`, `title`, `img`, `contant1`, `contant2`, `contant3`, `contant4` FROM `health`";
          ...
          <table style="width: 70%;">
            ...
            <tr><td style=" font-size: 15px; text-align: center; width: 30%; padding: 20px;"><a href="home-page-contant8-dataedit.php?id=<?php echo $data["id"]; ?>" type="button" class="btn btn-warning">Data Edit</a></td></tr>
            <?php $count++;}?>
          </table>
        </form>
      </div>
