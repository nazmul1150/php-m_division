  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <div class="data-update">
        <form action="home-page-contant7-dataupdate.php" method="post">
          <?php
          ...
          <table style="width: 70%;">
            ...
            <tr><td style=" font-size: 15px; text-align: center; width: 30%; padding: 20px;"><a href="home-page-contant7-dataedit.php?id=<?php echo $data["id"]; ?>" type="button" class="btn btn-warning">Data Edit</a></td></tr>
            <?php $count++;}?>
          </table>
        </form>
      </div>
