    ...
    <section class="content container-fluid">
      ...
      <a href="home-slider-img-datainsert.php" type="button" class="btn btn-info">Data Inseart</a>
          ...
          <div class="for-s">
             <?php
              $id= $_REQUEST['id'];
              $qul="SELECT * FROM `home_slider` WHERE `id`='$id';";
              $rul=mysqli_query($conn,$qul);
              $row=mysqli_fetch_assoc($rul);
              
              ?>
            <form method="post" action="home-slider-img-dataedit.php" enctype="multipart/form-data">
              <table>
                <tr>
                  <td>
...
if (isset($_POST['submit'])) {
 ...
 $sid= $_REQUEST['id'];
  ...
  $qur="UPDATE `home_slider` SET `img`='$file_name' WHERE `id`='$sid'";
