  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <a href="home-page-contant5-dataDelete.php" type="button" class="btn btn-danger">Data Delete</a>
        ...
        <form method="post" action="home-page-contant5-datainsart.php" enctype="multipart/form-data">
        <div class="row">
...
if (isset($_POST['submit'])) {
  ...
  $qur="INSERT INTO `bumi`(`title`, `img`, `contant1`, `contant2`, `contant3`, `contant4`) VALUES ('$h1','$file_name','$cn1','$cn2','$cn3','$cn4')";
